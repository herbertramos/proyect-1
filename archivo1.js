...
let totalContagiados = reduce((enfermosPorDia, acumulator) => acumulator + enfermosPorDia);
let promedio = totalContagiados / cov.length
console.log("promedio de contagiados", promedio)
...
cov = [
    ...
    let total = cov.reduce((enfermosPorDia, acumulator) => acumulator + enfermosPorDia);
